            ...
            <form
              ...
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  // Backend sets httpOnly cookies and returns user in body. Store only user client-side.
                 ...
                 {!isAdminLogin && (
                   <>
                     ...
                     <button
                       ...
                       onClick={async () => {
                         try {
                           // Ask backend to prepare Google OAuth2 authorization URL, then redirect the browser to Google
                           const resp = await api.get('/auth/socials/oauth2/google/login?role=creator');
                           const url = resp.data?.authorizationUrl;
